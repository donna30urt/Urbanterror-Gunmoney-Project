...
class CustomgunmoneyPlugin(b3.plugin.Plugin):
    ...
    def cmd_adminhelp(self, data, client, cmd=None):
        ...
        if (self.console.time() - last) < 45:
            ...
            fin = open("/home/urt2/urbanterror43/q3ut4/adminhelp.txt", "rt")
            data = fin.read()
            data = data.replace('XDATA1', client.name)
            fin.close()
            fin = open("/home/urt2/urbanterror43/q3ut4/adminhelp.txt", "wt")
            fin.write(data)
            fin.close()
    ...
    def cmd_help(self, data, client, cmd=None):
        ...
        if (self.console.time() - last) < 45:
            ...
            fin = open("/home/urt2/urbanterror43/q3ut4/helpfile.txt", "rt")
            data = fin.read()
            data = data.replace('XDATA1', client.name)
            fin.close()
            fin = open("/home/urt2/urbanterror43/q3ut4/helpfile.txt", "wt")
            fin.write(data)
            fin.close()
    ...
    def cmd_helpme(self, data, client, cmd=None):
        ...
        if (self.console.time() - last) < 60:
            ...
            fin = open("/home/urt2/urbanterror43/q3ut4/helpen.txt", "rt") 
            data = fin.read()
            data = data.replace('xdata1', client.name)
            fin.close()
            fin = open("/home/urt2/urbanterror43/q3ut4/helpen.txt", "wt")
            fin.write(data)
            fin.close()
    ...
    #        fin = open("/home/urt2/urbanterror43/q3ut4/nmap.txt", "rt")
    #        data = fin.read()
    #        data = data.replace('xdata1', mapname)
    #        data = data.replace('xdata2', nextmapname)
    #        fin.close()
    #        fin = open("/home/urt2/urbanterror43/q3ut4/nmap.txt", "wt")
    #        fin.write(data)
    #        fin.close()
    ...
    #        client.message('Please wait 45 seconds before you try again!')
    #    else:
    #        fin = open("/home/urt2/urbanterror43/q3ut4/buylist2.txt", "rt")
    #        data = fin.read()
    #        data = data.replace('xdata1', client.name)
    #        fin.close()
    #        fin = open("/home/urt2/urbanterror43/q3ut4/buylist2.txt", "wt")
    #        fin.write(data)
    #        fin.close()
    ...
    def cmd_bhi(self, data, client, cmd=None):
        ...
        if (self.console.time() - last) < 120:
            ...
            fin = open("/home/urt2/urbanterror43/q3ut4/hello2.txt", "rt")
            data = fin.read()
            data = data.replace('player1', client.name)
            data = data.replace('player2', sclient.name)
            fin.close()
            fin = open("/home/urt2/urbanterror43/q3ut4/hello2.txt", "wt")
            fin.write(data)
            fin.close()
    ...
    def cmd_bhiall(self, data, client, cmd=None):
        ...
        if (self.console.time() - last) < 600:
            ...
            fin = open("/home/urt2/urbanterror43/q3ut4/hello3.txt", "rt")
            data = fin.read()
            data = data.replace('player', client.name)
            fin.close()
            fin = open("/home/urt2/urbanterror43/q3ut4/hello3.txt", "wt")
            fin.write(data)
            fin.close()
